    ...
    for source_sent, target_sent in tqdm(zip(source_data, target_data)):
        ...
        try:
            ...
            try:
                ...
                print("Error 2", aligned_sent, "Error 2")
        ...
        if "".join(check_sent.split()) != "".join(
            ...
            try:
                ...
                print("Error 1", aligned_sent, "Error 1", source_sent, target_sent)
...
def convert_tagged_line(line, delimeters=SEQ_DELIMETERS):
    ...
    try:
        for x in line.split(delimeters['tokens']):
            try:
                a1 = x.split(label_del)[1]
            except Exception as e:
                print("Error1", x, "Error1")
                raise e
            a2 = a1.split(delimeters['operations'])
    except Exception as e:
        print("line1", line, "line1")
        raise e
